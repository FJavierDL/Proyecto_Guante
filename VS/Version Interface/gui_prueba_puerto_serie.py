...
class SerialReaderApp:
    def __init__(self, master):
        ...
        # Etiquetas para mostrar los valores de las variables
        ...
        # Etiqueta para mostrar la posición del máximo
        ...
        # Cuadro de texto para mostrar los datos del puerto serie
        self.textbox = tk.Text(master, height=10, width=50)
        self.textbox.grid(row=7, column=0, columnspan=2, pady=10)
